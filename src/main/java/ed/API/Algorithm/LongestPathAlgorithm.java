...
public class LongestPathAlgorithm implements Algorithm {
    @Override
    public EntitiesLocation move(Bot bot, Graph<EntitiesLocation> graph, EntitiesLocation otherPlayerLocation) {

        Iterator<EntitiesLocation> iterator = graph.iteratorLongestPath(bot.getLocation(), otherPlayerLocation);
